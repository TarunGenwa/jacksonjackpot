...
export default function Home() {
  ...
  return (
    <Box minH="100vh" bg={getThemeColor('dark')} py={6} pb={{ base: 32, lg: 12 }}>
          ...
          <DrawerContent bg={getThemeColor('secondary')} maxH="90vh">
            ...
            <DrawerBody p={4} overflowY="auto">
              <VStack spacing={6} align="stretch">
                  ...
                  <Box bg={getThemeColor('dark')} p={4} borderRadius="lg">
                    <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                      <GridItem>
                        <VStack align="start">
                          <Text fontSize="sm" color={getThemeColor('gray500')}>Ticket Price</Text>
                          <Text fontSize="xl" fontWeight="bold" color={getThemeColor('accent')}>
                            £{competitions[selectedCompetitionIndex].ticketPrice}
                          </Text>
                        </VStack>
                      </GridItem>
                      <GridItem>
                        <VStack align="start">
                          <Text fontSize="sm" color={getThemeColor('gray500')}>Draw Date</Text>
                          <Text fontSize="md" fontWeight="semibold" color={getThemeColor('white')}>
                            {new Date(competitions[selectedCompetitionIndex].drawDate).toLocaleDateString('en-GB', {
                              day: 'numeric',
                              month: 'short',
                              year: 'numeric'
                ...
                {/* Mobile Tabs */}
                <Box bg={getThemeColor('dark')} borderRadius="lg" p={4}>
                  <Tabs variant="soft-rounded" colorScheme="purple" defaultIndex={0} size="sm">
                            ...
                            <>
                              ...
                              {competitions[selectedCompetitionIndex].prizes.filter(p => p.type === 'INSTANT_WIN').length > 0 && (
                                <VStack spacing={2} align="stretch">
                                  ...
                                  <SimpleGrid columns={1} spacing={2}>
                                    {competitions[selectedCompetitionIndex].prizes.filter(p => p.type === 'INSTANT_WIN').slice(0, 5).map((prize) => (
                                      <Box
                                        key={prize.id}
                                        bg={getThemeColor('secondary')}
                                        p={3}
                                    ...
                                    {competitions[selectedCompetitionIndex].prizes.filter(p => p.type === 'INSTANT_WIN').length > 5 && (
                                      <Text fontSize="xs" color={getThemeColor('gray500')} textAlign="center">
                                        +{competitions[selectedCompetitionIndex].prizes.filter(p => p.type === 'INSTANT_WIN').length - 5} more instant win prizes
                                      </Text>
                                    )}
                                  </SimpleGrid>
                                </VStack>
                      ...
                      <TabPanel px={0}>
                        <Accordion allowToggle>
                          <AccordionItem border="none" mb={2}>
                            ...
                            <AccordionPanel pb={3} bg={getThemeColor('secondary')} borderBottomRadius="md" color={getThemeColor('gray300')} border="1px" borderColor={getThemeColor('primary')} borderTop="none" fontSize="sm">
                              Simply close this window and use the checkout section to select tickets and complete your purchase.
                            </AccordionPanel>
                          </AccordionItem>
                          ...
                          <AccordionItem border="none">
                            ...
                            <AccordionPanel pb={3} bg={getThemeColor('secondary')} borderRadius="md" color={getThemeColor('gray300')} border="1px" borderColor={getThemeColor('primary')} borderTop="none" fontSize="sm">
                              20% of the proceeds from ticket sales go directly to {competitions[selectedCompetitionIndex].charity.name}, with the remainder covering operational costs and platform fees.
                            </AccordionPanel>
                          </AccordionItem>
                        </Accordion>
